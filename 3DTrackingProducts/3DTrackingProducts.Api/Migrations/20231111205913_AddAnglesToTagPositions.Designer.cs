...
namespace _3DTrackingProducts.Api.Migrations
{
    ...
    [Migration("20231111205913_AddAnglesToTagPositions")]
    partial class AddAnglesToTagPositions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("_3DTrackingProducts.Api.Models.Auth.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "58e175d3-683e-4611-b5fd-8f94ff3bb29e",
                            Email = "admin@email.pt",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@EMAIL.PT",
                            PasswordHash = "AQAAAAIAAYagAAAAEMr9CW7D+TMvg8+IJoM9e4lj+YZx7BQbYmJ/XFr9Z4YKYWPYvEWqSOFJtVO1bTwDeg==",
            ...
            modelBuilder.Entity("_3DTrackingProducts.Api.Models.PairAntenna", b =>
                {
                    ...
                    b.Property<int>("DetectingState")
                        .HasColumnType("int");

                    b.Property<DateTime?>("LastVerificationTimeStamp")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("_3DTrackingProducts.Api.Models.Tag3DPosition", b =>
                {
                    ...
                    b.Property<double>("DistanceHigh")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("_3DTrackingProducts.Api.Models.TagPosition", b =>
                {
                    ...
                    b.Property<double>("angleAntenna01")
                        .HasColumnType("float");

                    b.Property<double>("angleAntenna02")
                        .HasColumnType("float");
